    ...
    <section id="contact" className="py-20 bg-slate-800 text-white">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 bg-sky-500 hover:bg-sky-400 text-white font-semibold px-8 py-4 rounded-full text-lg transition-colors shadow-lg"
        >
          <svg
            width="20"
            height="20"
        ...
        {/* Footer */}
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-white/40 text-sm">
          <span>
